...
class SalaryOfficialVVP extends Model
{
    use HasFactory;
    ...
    //relationship SalaryOfficialVVPTimekeepings
    public function SalaryOfficialVVPTimekeepings()
    {
        return $this->hasMany(SalaryOfficialVVPTimekeeping::class, 'salary_official_vvp_id', 'id');
    }
