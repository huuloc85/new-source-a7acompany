...
class SalaryOfficialA7ACategoryImport implements HasReferencesToOtherSheets, SkipsEmptyRows, SkipsOnFailure, ToArray, WithStartRow, WithChunkReading, WithEvents, WithCalculatedFormulas
{
    ...
    public function array(array $rows)
    {
        try {
            ...
            $this->batchUpdateOrInsert(SalaryOfficialA7A::class, $insertData, 500);
        } catch (\Exception $e) {
            LogHelper::saveLog('Import-Category-A7A', $e->getMessage(), $e->getLine());
            Log::error('Import Category A7A error: '.$e->getMessage().' line '.$e->getLine());
            throw $e;
        }
    }
