            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar">
                @if (auth()->user()->role->role_name == 'admin' ||
                    ...
                    @if (auth()->user()->role->role_name == 'admin')
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Mã Vạch">
                                <i class="icon-svg">
                ...
                @if (auth()->user()->role->role_name != 'admin' &&
                    ...
                    @if (Auth()->user()->role_id == 4)
                        <li class="nav-item">
                            <a class="nav-link route('admin.barcode.scan')"
                                href="{{ route('admin.barcode.scan') }}" title="Mã Vạch">
                                <i class="icon-svg">
