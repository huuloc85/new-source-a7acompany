...
<html lang="en">
    ...
    <body>
        <audio id="background-music" autoplay="autoplay" loop>
            <source
                src="{{ asset('assets/music/new-year.mp3') }}"
                type="audio/mp3"
            />
        </audio>
        ...
        <div class="wrapper">
            <section class="login-content">
                <div
                    class="row m-0 align-items-center bg-white vh-100 position-relative"
                >
                    <div class="col-md-6">
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                <div class="my-5">
                                    <div class="card-body">
                                        <h1 class="text-white text-icons">
                                        ...
                                        <h2 class="mb-2 text-center text-white">
                                            Đăng Nhập
                                        </h2>
                                        <h6
                                            class="text-icons"
        ...
        <script>
            ...
            const getExpirationDate = () => {
                ...
                return today <= christmas
                    ? christmas
                    : new Date(`${year + 1}-01-29T00:00:00`);
            };
