      ...
      <div class="col-auto">
        <div class="avatar avatar-xl position-relative">
          @if(Auth()->user()->role->role_name == 'admin' || 
            ...
            <img src="{{ asset('storage/admin/' .Auth()->user()->photo) }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
          @else
            <img src="{{ asset('storage/employee/' .Auth()->user()->photo) }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
          @endif
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="text" value="{{old('name') ?? Auth()->user()->name ?? ''}}" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Tên" disabled>
                    @error('name')
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" value="{{old('phone') ?? Auth()->user()->phone ?? ''}}" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Tên đăng nhập" disabled>
                    @error('phone')
                      <div class="text text-danger">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-12 col-md-6">
                  <div class="mb-3">
                    ...
                    <input accept="image/*" type='file' id="inputFile" name="photo" class="form-control">
                    <img type="hidden" width="66px" height="66px" id="blah1" src="{{ asset('storage/admin/' . Auth()->user()->photo) }}" alt="" />
                  </div>
                </div>
              </div>
              ...
              <form action="{{route('admin.change-info')}}" method="post">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" value="{{ Auth()->user()->code ?? ''}}" name="code" class="form-control">
                    @error('code')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" value="{{ Auth()->user()->date_joining ?? ''}}" name="date_joining" class="form-control">
                    @error('date_joining')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <img type="hidden" width="66px" height="66px" id="blah1" src="{{ asset('storage/employee/' . Auth()->user()->photo) }}" alt="" />
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" value="{{ Auth()->user()->CCCD ?? ''}}" name="CCCD" class="form-control">
                    @error('CCCD')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" value="{{ Auth()->user()->gender ?? ''}}" name="gender" class="form-control">
                    @error('gender')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" value="{{ Auth()->user()->marital_status ?? ''}}" name="marital_status" class="form-control">
                  ...
                  <div class="mb-3">
                    ...
                    <img type="hidden" width="66px" height="66px" id="blah1" src="{{ asset('storage/employee/card/' . Auth()->user()->card_photo) }}" alt="" />
                  </div>
                </div>
        ...
        <div class="info">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="mb-3">
                  ...
                  <input type="password" value="" name="newpassword" class="form-control @error('newpassword') is-invalid @enderror" placeholder="Mật khẩu mới" required>
                  @error('newpassword')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="mb-3">
                  ...
                  <input type="password" value="" name="renewpassword" class="form-control @error('renewpassword') is-invalid @enderror" placeholder="Nhập lại mật khẩu mới" required>
                  @error('renewpassword')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="col-12 col-md-6">
                <div class="mb-3">
                  ...
                  <input type="password" value="" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Mật khẩu cũ" required>
                  @error('password')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
                </div>
          ...
          <div class="col-12 col-sm-6 flex-shrink-1 bd-highlight">
            <form action="{{route('admin.reset-password', Auth()->user()->id)}}" method="post">
              @csrf
              <button type="submit" onclick="return confirm('Bạn có chắc chắn muốn khôi phục lại mật khẩu?');" class="btn btn-danger">Khôi phục mật khẩu</button>
            </form>
          </div>
        </div>
      </div>
