                        ...
                        <div class="container-fluid">
                            ...
                            <div class="table-wrapper">
                                <table class="table align-items-center mb-0 table-hover">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" title="STT">STT</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" title="Tên linh kiện">Tên linh kiện</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" title="Tổng số lượng tồn hiện tại">Tổng số lượng tồn hiện tại
                                            </th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" title="Còn lại trong tuần">Còn lại trong tuần</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" title="Đã xuất trong tuần">Đã xuất trong tuần</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" title="Tồn đầu tuần">Tồn đầu tuần</th>
                                    ...
                                    <table class="table align-items-center mb-0 table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Tên linh
                                                    kiện</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Tổng cộng
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
