    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div
                        class="card-header p-2 position-relative mt-n1 mx-1 no-print"
                    >
                    ...
                    <div class="d-flex my-2 ps-2 align-items-center">
                        ...
                        <form
                            action="{{ route('admin.history-import-quantity') }}"
                            method="get"
                            id="searchForm"
                    ...
                    <div class="px-0 pb-2">
                        <div class="tab-content" id="myTabContent">
                            ...
                            @else
                                <form
                                    action="{{ route('admin.checkpo.update') }}"
                                    method="POST"
                                >
                                    @csrf
                                    <div
                                    ...
                                    @if ($selectedDate)
                                        ...
                                        >
                                            @foreach ($products as $product)
                                                ...
                                                <div
                                                    class="product-card col-12 col-sm-6 col-md-4 col-lg-3 mb-3"
                                                >
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            >
                                                <thead>
                                                    <tr>
                                                        <th
                                                            class="text-center text-uppercase text-md font-weight-bolder"
                                                        >
                                                            STT
                                                        </th>
                                                        <th
