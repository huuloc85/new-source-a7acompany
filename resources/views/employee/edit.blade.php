                        ...
                        <form action="{{ route('admin.employee.update', $employee->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Công ty hoạt động<span class="required">*</span></label>
                                        <select class="form-control @error('company') is-invalid @enderror" name="company"
                                            required>
                                            <option value="">Chọn công ty</option>
                                            <option value="Vinh Vinh Phát"
                                                {{ old('company', $employee->company) == 'Vinh Vinh Phát' ? 'selected' : '' }}>
                                                Vinh Vinh Phát
                                            </option>
                                            <option value="A7A"
                                                {{ old('company', $employee->company) == 'A7A' ? 'selected' : '' }}>
                                                A7A
                                            </option>
                                        </select>
                                        @error('company')
