                                            ...
                                            <div
                                                ...
                                                <div class="text-start pt-1">
                                                    <h6 class="mb-0">{{ $formatDate->formatTimeDMY($date) }} -
                                                        {{ $formatDate->dayOfWeek($date) }}</h6>
                                                </div>
                                                <div class="text-end pt-1 me-2">
                                                    <h6 class="mb-0 {{ $celenderDetailHNHC->$fill ?? '' }}">
                                                        {{ $celenderDetailHNHC->$fill ?? '' }}</h6>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                                    ...
                                                    <div class="card-footer p-2 d-flex justify-content-between">
                                                        ...
                                                        <div class="text-end pt-1 me-2">
                                                            <h6
                                                                ...
                                                                {{ $celenderDetailWCCleanWomen->$fill ?? '' }}</h6>
                                                        </div>
                                                    </div>
                                                @endif
                                            @endforeach
                                                    ...
                                                    <div class="card-footer p-2 d-flex justify-content-between">
                                                        ...
                                                        <div class="text-end pt-1 me-2">
                                                            <h6 class="mb-0 {{ $celenderDetailWCCleanMen->$fill ?? '' }}">
                                                                {{ $celenderDetailWCCleanMen->$fill ?? '' }}</h6>
                                                        </div>
                                                    </div>
                                                @endif
                                            @endforeach
