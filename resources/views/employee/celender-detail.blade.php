                    ...
                    <div class="table-responsive p-0">
                        <div class="row mx-2">
                            ...
                            @if (isset($celenderDetailHNHC))
                                <div
                                    class="col-xl-3 col-sm-6 mb-xl-0 mb-4 mt-4"
                                >
                                    <div class="card mb-2">
                                        ...
                                        <div
                                            class="card-footer p-2 d-flex justify-content-between"
                                        >
                                    ...
                                    <div class="card">
                                        ...
                                        @foreach ($dates as $key => $date)
                                            ...
                                            >
                                                ...
                                                <div class="text-end pt-1 me-2">
                                                    <h6
                                                        class="mb-0 {{ $celenderDetailHNHC->$fill ?? '' }}"
                                                    >
                                        ...
                                        @foreach ($dates as $key => $date)
                                            ...
                                            @if ($celenderDetailEatroom->$fill != null)
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="text-end pt-1 me-2"
                                                    >
                                                        <h6
                                                            class="mb-0 {{ $celenderDetailEatroom->$fill ?? '' }}"
                                                        >
                                            ...
                                            @if ($formatDate->dayOfWeek($date) == 'T7')
                                                ...
                                                @if ($celenderDetailWC->$fill != null)
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <h6
                                                                class="mb-0 {{ $celenderDetailWC->$fill ?? '' }}"
                                                            >
                                            ...
                                            @foreach ($dates as $key => $date)
                                                ...
                                                @if ($celenderDetailWCCleanMen->$fill != null)
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <h6
                                                                class="mb-0 {{ $celenderDetailWCCleanMen->$fill ?? '' }}"
                                                            >
