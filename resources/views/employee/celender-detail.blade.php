                    ...
                    <div class="row mx-2">
                        ...
                        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4 mt-4">
                            ...
                            <div class="card">
                                ...
                                $fill = 'day' . $key + 1;
                                ?>
                                <div class="card-footer p-2 d-flex justify-content-between {{ $formatDate->dayOfWeek($date) }}">
                                    <div class="text-start pt-1">
                        ...
                        {{-- Trực WC --}}
                        @if (isset($celenderDetailWCClean))
                        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4 mt-4">
                            <div class="card mb-2">
                                <div class="card-header p-3 pt-2">
                                    <div class="text-start pt-1">
                                        <h6 class="mb-0">Chú thích lịch trực WC</h6>
                                    </div>
                                </div>
                                <hr class="dark horizontal my-0">
                                <div class="card-footer p-2 d-flex justify-content-between">
                            ...
                            <div class="card">
                                <div class="card-header p-3 pt-2">
                                    <div class="text-start pt-1">
                                        <h6 class="mb-0">Lịch trực WC</h6>
                                    </div>
                                </div>
                                <hr class="dark horizontal my-0">
                                <?php $checkWCClean = false; ?>
                                @foreach ($dates as $key => $date)
                                <?php $fill = 'day' . $key + 1; ?>
                                @if ($celenderDetailWCClean->$fill != null)
                                <?php $checkWCClean = true; ?>
                                <div class="card-footer p-2 d-flex justify-content-between">
                                    <div class="text-start pt-1">
                                        <h6 class="mb-0">{{ $formatDate->formatTimeDMY($date) }} -
                                            {{ $formatDate->dayOfWeek($date) }}
                                    ...
                                    <div class="text-end pt-1 me-2">
                                        <h6 class="mb-0 {{ $celenderDetailWCClean->$fill ?? '' }}">
                                            {{ $celenderDetailWCClean->$fill ?? '' }}
                                        </h6>
                                    </div>
                                </div>
                                @endif
                                @endforeach
                                @if ($checkWCClean == false)
                                <div class="card-footer p-2 d-flex justify-content-between">
                                    <div class="text-start pt-1">
                                        <h6 class="mb-0">Hiện tại chưa có phân công.</h6>
                                    </div>
