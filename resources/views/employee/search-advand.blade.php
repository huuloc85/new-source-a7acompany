                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <select
                                    ...
                                    id="calendar_category_id"
                                    style="width: 470px">
                                    <option style="text-align: center" value="">----- Chọn danh mục -----</option>
                                    @foreach ($categories as $category)
                                        <option
                                            <?= request()->calendar_category_id == $category->id ? "selected" : "" ?>
                                            value="{{ $category->id }}">
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
