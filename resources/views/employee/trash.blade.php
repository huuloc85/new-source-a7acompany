            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Thùng Rác Nhân Sự</h4>
                    </div>
                </div>
                <div class="p-4 pb-0 d-flex">
                    <a href="{{ route('admin.employee.home') }}" type="button" class ='btn btn-success'>Danh Sách Nhân Sự</a>
                ...
                <div class="px-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 table-hover">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-xxs font-weight-bolder">STT</th>
                                    <th class="text-uppercase text-xxs font-weight-bolder col-2">Tên/Điện thoại</th>
                                    <th class="text-center text-uppercase text-xxs font-weight-bolder ps-2 col-2">Chức vụ
                                    </th>
                                    <th class="text-center text-uppercase text-xxs font-weight-bolder ps-2 col-2">Mã nhân
                                        viên</th>
                                    <th class="text-center text-uppercase text-xxs font-weight-bolder ps-2 col-3">Danh mục
                                        lịch làm việc</th>
                                    <th class=""></th>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <p class="text-xs font-weight-bold mb-0">
                                                {{ $employee->category_celender->name }}</p>
                                        </td>
