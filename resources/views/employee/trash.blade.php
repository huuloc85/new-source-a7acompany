    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.employee.home') }}" type="button" class="btn btn-link mb-3">
                        <i class="fas fa-arrow-left"></i>
                        Quay lại
                    </a>
                    <div class="d-flex flex-wrap-reverse justify-content-between align-items-center gap-3 mb-3">
                        <div>
                            <span class="fw-bold">
                                {{ $startValue }}
                            </span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr class="text-uppercase table-light text-center">
                                    <th>STT</th>
                            ...
                            <tbody>
                                @foreach ($employees as $key => $employee)
                                    ...
                                    {{-- Modal revert --}}
                                    <div class="modal fade" id="revertModal-{{ $employee->id }}" tabindex="-1"
                                        aria-labelledby="revertModalLabel-{{ $employee->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="revertModalLabel-{{ $employee->id }}">
                                                        Khôi phục nhân viên
                                                    </h5>
                                ...
                                @if ($total == 0)
                                    <tr>
                                        <td colspan="6" class="text-center pt-4">
                                            ...
                                            thùng rác.
                                            <a class="href" href="{{ route('admin.employee.home') }}">
                                                Danh sách nhân viên
                                            </a>
                                        </td>
                                    </tr>
