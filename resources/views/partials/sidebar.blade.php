                ...
                @if (auth()->user()->role->role_name == 'admin' ||
                    ...
                    @if (auth()->user()->role->role_name == 'admin')
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="nhansuDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false" title="Nhân Sự">
                                <i class="icon-svg">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="nhansuDropdown">
                                <li>
                                    <a class="dropdown-item {{ route('admin.employee.home') }}"
                                        href="{{ route('admin.employee.home') }}" title="Nhân Sự">
                                        <i class="icon-svg">
                                            <svg width="20" height="20" id="Layer_1" data-name="Layer 1"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 108.81 122.88">
                                                <defs>
                                                    <style>
                                                        .cls-1 {
                                                            fill-rule: evenodd;
                                ...
                                <li>
                                    <a class="dropdown-item {{ route('admin.role.home') }}"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="planDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false" title="Kế hoạch">
                                <i class="icon-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
                                        <path
                                            d="M3.5 0a.5.5 0 0 1 .5.5V1h9V.5a.5.5 0 0 1 1 0V1h1a.5.5 0 0 1 .5.5V2h-14V1a.5.5 0 0 1 .5-.5zM0 4v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4H0zm14 12H2V6h12v10z" />
                                    </svg>
                                </i>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="planDropdown">
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.product-plan.index') }}"
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.material.index') }}"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.product.barcode.history') }}">
                                    <i class="icon-svg me-2">
                                        <!-- Biểu tượng tài liệu hoặc lịch sử -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Chấm Công">
                                <i class="icon-svg">
                                    <!-- Biểu tượng đồng hồ hoặc chấm công -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
