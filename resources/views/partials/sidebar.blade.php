...
<aside class="sidebar sidebar-default navs-rounded-all sidebar-base no-print">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar">
                @if (auth()->user()->role->role_name == 'admin' ||
                    ...
                    @if (auth()->user()->role->role_name == 'admin')
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('admin.home') }}"
                                aria-current="page"
                                href="{{ route('admin.home') }}"
                                title="Trang Chủ"
                            >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul
                                class="dropdown-menu"
                                aria-labelledby="nhansuDropdown"
                            >
                                <li>
                                    <a
                                        class="dropdown-item {{ route('admin.employee.home') }}"
                                ...
                                <li>
                                    <a
                                        class="dropdown-item {{ route('admin.role.home') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.product.home')"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.checkemployee.view-employee-todo')"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            >
                                <a
                                    class="dropdown-item"
                                    href="{{ route('admin.product.barcode') }}"
                                >
                                ...
                                <a
                                    class="dropdown-item"
                                    href="{{ route('admin.product.barcode.history') }}"
                                >
                                    <i class="icon-svg me-2">
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.checkpo.index')"
                                href="{{ route('admin.checkpo.index') }}"
                                title="Kiểm Tra PO"
                            >
                                <i class="icon-svg">
                                    <svg
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.history.home')"
                                href="{{ route('admin.history.home') }}"
                                title="Lịch Sử"
                            >
                                <i class="icon-svg">
                                    <svg
                    ...
                    @if (auth()->user()->role->role_name == 'manager' || auth()->user()->role->role_name == 'admin')
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.celender.home')"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.category.home')"
                    ...
                    @if (auth()->user()->role->role_name == 'accountant' || auth()->user()->role->role_name == 'admin')
                        <li class="nav-item">
                            <a
                                class="nav-link route('admin.salary.home')"
                ...
                @if (auth()->user()->role->role_name != 'admin' &&
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link route('admin.employee-show.celender')"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link route('admin.employee-show.salary')"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            <a
                                class="dropdown-item"
                                href="{{ route('admin.employee.attendence') }}"
                            >
                                <i class="icon-svg me-2">
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link route('admin.profile')"
    ...
    <div
        class="sidebar-footer p-3 left-1"
