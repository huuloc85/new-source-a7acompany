                            ...
                            <ul class="swiper-wrapper list-inline m-0 p-0 mb-2 slide-hover">
                                    ...
                                    <div class="card-body">
                                        <a href="{{ route('admin.attendence.records') }}">
                                            <div class="progress-widget">
                                                ...
                                                <div class="progress-detail">
                                                    <h6 class="text-sm mb-0 text-capitalize">
                                                        <i class="fas fa-calculator fa-lg mr-2"></i>
                                                        Bảng Tính Toán Chấm Công
                                                    </h6>
                                                    <h4 class="mb-0">
                                                        {{ \Carbon\Carbon::parse($today)->format('m-Y') }}</h4>
                                                </div>
                                            </div>
                                        </a>
                                        <div class="card-footer p-3">
                                ...
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer p-3">
                                            <p class="mb-2">Đi đến <a href="{{ route('admin.role.home') }}">danh sách
                                                    chức
                                                    vụ.</a></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer p-3">
                                            <p class="mb-2">Đi đến <a
                                                    ...
                                                    nhân viên làm việc trong ngày.</a></p>
                                        </div>
                                    </div>
                                </li>
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                        ...
                                        <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                            <div class="card-body">
                                                <a href="{{ route('admin.celender.home') }}"><i
                                                        class="material-icons opacity-10 text-white">calender</i>
                                                    <div class="progress-widget">
                                                        <div id="circle-progress-01"
                                                            class="circle-progress-01 circle-progress circle-progress-primary text-center"
                                                            data-min-value="0" data-max-value="100" data-value="90"
