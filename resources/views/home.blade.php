                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col overflow-hidden">
                                            ...
                                            <div class="fs-4 fw-semibold">{{ $widget['data'] }}</div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            @if ($totalSalary == 0)
                                                <tr>
                                                    <td colspan="4" class="text-center pt-4">Hiện tại chưa có bảng
                                                        lương
                                                        nào.<br>Vui lòng
                                                        <a class="href" href="{{ route('admin.salary.getimport') }}">Thêm
                                                            bảng
                                                            lương</a>
                                                    </td>
                                                </tr>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xxl-3">
                    <a class="card bg-body-tertiary border-transparent shadow text-decoration-none"
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <p class="fw-semibold align-items-center text-capitalize">{{ $widget['title'] }}</p>
                                </div>
                                <div class="col-auto">
                                    <div class="avatar avatar-lg bg-body text-black">
                                        <i class="{{ $widget['icon'] }}"></i>
