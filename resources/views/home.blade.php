                                ...
                                <div class="card-body">
                                    <a href="{{ route('admin.celender.home') }}"><i
                                        ...
                                        <div class="progress-widget">
                                            ...
                                            <div class="progress-detail">
                                                <h4 class="text-sm mb-0 text-capitalize">Lịch làm việc nhân
                                                    viên</h4>
                                            </div>
                                        </div>
                                    </a>
                ...
                <ul class="swiper-wrapper list-inline m-0 p-0 mb-2">
                    <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                        <div class="card-body">
                            ...
                            <div class="card-footer p-3">
                                <p class="mb-0">Đi đến <a
                                        href="{{ route('admin.employee-show.celender') }}">lịch làm việc.</a></p>
                            </div>
                        </div>
                    </li>
                    <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                        <div class="card-body">
                            ...
                            <div class="card-footer p-3">
                                <p class="mb-2">Đi đến <a href="{{ route('admin.employee-show.salary') }}">bảng
                                        lương.</a></p>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.employee.check-employee-todo') }}"><i
                                ...
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        <h4 class="text-sm mb-0 text-capitalize">Chọn sản phẩm hoạt động </h4>
                                    </div>
                                </div>
                            </a>
                            <div class="card-footer p-3">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.employee-history-check') }}"><i
                                ...
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        <h4 class="text-sm mb-0 text-capitalize">Lịch sử nhập hàng ngày </h4>
                                    </div>
                                </div>
                            </a>
                            <div class="card-footer p-3">
                                <p class="mb-0">Đi đến <a href="{{ route('admin.employee-history-check') }}">Đi
                                        đến lịch sử
                                        nhập sản phẩm.</a>
                                </p>
                            </div>
                    ...
                    <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                        <div class="card-body">
                            ...
                            <div class="card-footer p-3">
                                <p class="mb-0">Đi đến <a href="{{ route('admin.profile') }}">thông tin tài
                                        khoản.</a></p>
                            </div>
                        </div>
                    </li>
