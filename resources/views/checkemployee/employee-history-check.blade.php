            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Lịch Sử Các Bản Ghi Của Nhân Viên</h4>
                    </div>
                </div>
                <div class="card-body">
