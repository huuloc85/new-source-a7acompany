                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Thời gian Bắt Đầu</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Thời gian Kết Thúc</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Nhân Viên</th>
