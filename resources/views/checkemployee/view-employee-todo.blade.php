            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column flex-sm-row gap-2 mb-3">
                        <a href="{{ route('admin.daily.productivity.history') }}" class="btn btn-primary">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @foreach ($checkEmployeeHistoryForAdmin as $checkEmployee)
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editModalLabel-{{ $checkEmployee->id }}">
                                                        Chỉnh Sửa Bản Ghi
                                                    </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select
                                                                ...
                                                                id="status" name="status" aria-label="Chọn trạng thái"
                                                                disabled>
                                                                <option value="1"
                                    ...
                                    {{-- Modal delete --}}
                                    <div class="modal fade" id="deleteModal-{{ $checkEmployee->id }}" tabindex="-1"
                                        aria-labelledby="deleteModalLabel-{{ $checkEmployee->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
