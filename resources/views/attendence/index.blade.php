                        ...
                        <table class="table table-hover">
                            <thead class="table-light text-uppercase">
                                <tr>
                                    ...
                                    <th class="text-center" scope="col">Ngày Chấm</th>
                                    <th class="text-center" scope="col">Thời Gian</th>
                                    <th class="text-center" scope="col">Danh Mục Làm Việc</th>
                            ...
                            <tbody>
                                @foreach ($records as $record)
                                    ...
                                    <div
                                        class="modal fade"
                                        id="modalDelete-{{ $loop->iteration }}"
                                        tabindex="-1"
                                        aria-labelledby="modalDeleteLabel-{{ $loop->iteration }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <p>
                                                        Bạn có chắc chắn muốn xóa dữ liệu chấm công
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="employee_name" name="employee_name" required>
                            ...
                            @foreach ($employees as $employee)
                                <option value="{{ $employee->name }}" data-code="{{ $employee->id }}">
                                    {{ $employee->name }}
                                </option>
                            @endforeach
                        </select>
