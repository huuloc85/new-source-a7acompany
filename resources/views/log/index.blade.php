            ...
            <div class="card">
                ...
                <div class="p-4 pb-0 d-flex">
                    ...
                    >
                        @csrf
                        <button
                            onclick="return confirm('Bạn có chắc muốn xóa tất cả Log không?');"
                            type="sunbmit"
                ...
                <div class="px-0 pb-2">
                    <div class="table-responsive p-0">
                        <table
                            class="table align-items-center mb-0 table-striped"
                        >
                            <thead>
                                <tr>
                                    <th
                                    ...
                                    <th
                                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-2"
                                    >
                                        Vị trí
                                    </th>
                                    <th
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            >
                                                ...
                                                @csrf
                                                <button
                                                    onclick="return confirm('Bạn có chắc muốn xóa Log này không?');"
                                                    class="btn btn-danger"
                                                    type="submit"
                                                >
                                                    Xóa
