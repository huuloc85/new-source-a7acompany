                                ...
                                <div class="table-responsive p-0 d-flex">
                                    ...
                                    <div class="col-10 product-tab">
                                        <table class="table align-items-center mb-0 table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 bg-3"
                                                        rowspan="2">SẢN LƯỢNG<br>(MOQ)</th>
                                                    <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 bg-3"
                                                        rowspan="2">THUNG CATON/THANG<br>(MOQ)</th>
                                                    {{-- <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 bg-4"
                                                    rowspan="2">Kích thước<br> khuôn</th>
                                                <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 bg-4"
                                                    rowspan="2">Số CAV<br>(cái/ shot)</th>
                                                <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 bg-4"
                                                    rowspan="2">Chu kì<br>(s/shot)<br></th> --}}
                                                    <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 bg-2"
                                                ...
                                                @endforeach --}}
                                                    ...
                                                    @endforeach
                                                    <th class="text-uppercase text-center text-xxs font-weight-bolder col-1"
                                        ...
                                        <table class="table align-items-center mb-0 table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-uppercase text-xxs font-weight-bolder col-1 text-center"
                                            ...
                                            <thead>
                                                <tr>
                                                    @foreach ($listDate as $key => $date)
                                                        <th class="text-uppercase text-center text-xxs font-weight-bolder <?= $key % 2 == 0 ? 'bg-3' : 'bg-2' ?>"
                                                            colspan="2">{{ $date }}</th>
                                                    @endforeach
                                                    <th class="text-uppercase text-center text-xxs font-weight-bolder col-1"
                                                        rowspan="2">THAO TÁC</th>
                                    ...
                                    <div class="col-7 product-tab-2">
                                        <table class="table align-items-center mb-0 table-hover">
                                            <thead>
                                                <tr>
                                                    @foreach ($listDate as $key => $date)
                                                        <th class="text-uppercase text-center text-xxs font-weight-bolder col-1 <?= $key % 2 == 0 ? 'bg-3' : 'bg-2' ?>"
