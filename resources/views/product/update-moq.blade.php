        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Cập Nhật Sản Lượng MOQ Tồn Đầu Kỳ Tồn 200%</h4>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.product.handle-update-moq') }}" method="post">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group ml-3" style="display: inline-block;">
                            ...
                            <select class="form-select w-auto" name="status" id="status" required aria-label="Chọn loại sản lượng" onchange="showNearData()">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 30px;" class="my-4">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <input type="number" style="height:27px; width:100px; margin-right:50px" min="0" class="form-control quantity-input" name="quantity[]">
                        </div>
                        @endforeach
                        @endif
                    </div>
