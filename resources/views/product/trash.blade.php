                            ...
                            <tbody>
                                @foreach ($products as $key => $product)
                                    ...
                                    <div class="modal fade" id="restoreModal-{{ $product->id }}" tabindex="-1"
                                        aria-labelledby="restoreModalLabel-{{ $product->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="restoreModalLabel-{{ $product->id }}">
                                                        Khôi Phục Sản Phẩm
                                                    </h5>
                                ...
                                @if ($total == 0)
                                    <tr>
                                        <td colspan="9999" class="text-center pt-4">
                                            Hiện tại chưa có sản phẩm nào trong
                                            thùng rác.
                                            <a class="href" href="{{ route('admin.product.home') }}">
