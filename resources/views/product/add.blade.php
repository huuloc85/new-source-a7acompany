                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input
                                            type="checkbox"
                                            <?= old("company.FAPV") == "1" ? "checked" : "" ?>
                                            name="company[]"
                                            value="FAPV"
                                        />
                                        <label for="html">FAPV出荷</label>
                                        &nbsp&nbsp&nbsp
                                        <input
                                            type="checkbox"
                                            <?= old("company.FASV") == "1" ? "checked" : "" ?>
                                            name="company[]"
                                            value="FASV"
                                        />
                                        <label for="css">FASV出荷</label>
                                        &nbsp&nbsp&nbsp
                                        <input
                                            type="checkbox"
                                            <?= old("company.FAVV") == "1" ? "checked" : "" ?>
                                            name="company[]"
                                            value="FAVV"
                                        />
                                        <label for="css">FAVV出荷</label>
                                        <br />
                                    </div>
                                </div>
                            </div>
