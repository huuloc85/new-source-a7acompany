        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="p-4 pb-0 d-flex flex-column flex-sm-row">
                    <a
                        class="btn btn-dark mb-2 mb-sm-0 me-sm-2"
                    ...
                    <a
                        class="btn btn-danger mb-2 mb-sm-0 me-sm-2"
                    ...
                    <a
                        class="btn btn-warning mb-2 mb-sm-0"
                ...
                >
                                ...
                                <div class="justify-content-between pt-3">
                                    ...
                                    <div class="text-end">
                                        <input
                                            ...
                                            oninput="formatAndStoreValue(this)"
                                            id="formattedInput"
                                            required
                                        />
                                        <input
                    ...
                    <div class="p-4 pb-0 d-flex">
                        <button type="submid" class="btn btn-success">
                            Cập Nhật
                        </button>
                    </div>
                </form>
