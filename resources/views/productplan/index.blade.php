                ...
                >
                    <div class="border-radius-lg ps-2 pt-4 pb-3">
                        <h4 class="card-title mb-0">
                            Kế Hoạch Sản Xuất Tháng {{ $currentMonth }}
                        </h4>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    >
                        ...
                        >
                            <div class="form-group">
                                <select
                                    class="form-control @error('month') is-invalid @enderror bg-light border-primary"
                                    id="month"
                                    name="month"
                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        rowspan="3"
                                        class="text-center text-uppercases"
