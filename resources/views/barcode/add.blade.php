                    ...
                    <form action="{{ route('admin.barcode.register') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <small class="form-text text-muted">
                                    <strong>
                                        Lưu ý: Trường hợp nếu cần in lại nhiều
                                        tem với số thùng khác nhau thì nhập số
                                        lượng tem theo các số lượng cần in, ví
                                        dụ: cần in 2 tem lẻ 1,2 thì nhập số
                                        lượng là 2
                                    </strong>
                                </small>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <small class="form-text text-muted">
                                    <strong>
                                        Lưu ý: Trường hợp nếu cần in lại nhiều
                                        tem với số thùng khác nhau thì nhập cách
                                        mỗi số thùng ví dụ thùng 1 và 2 thì
                                        nhập, ví dụ: 1,2
                                    </strong>
                                </small>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="number" min="1" id="product_pcs"
                                    ...
                                    value="{{ $product->quanEntityBin ?? '' }}" required readonly />
                                @error('pcs')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                        ...
                        <div>
                            <div class="col-12 no-print">
                                ...
                                <a class="btn btn-primary" href="{{ route('admin.product.barcode') }}">
                                    Làm mới
                                </a>
                            </div>
                        </div>
            ...
            @if (isset($binArray))
                <div class="card">
                    ...
                    <div class="card-body">
                                                ...
                                                @if ($bin['bin'] != 'xxxx')
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr class="moc-style">
                                                            ...
                                                            <td colspan="3"></td>
                                                            <td colspan="1" class="position-relative">
                        ...
                        <div class="no-print">
                            <a class="btn btn-secondary" data-url="{{ route('admin.barcode.save.print') }}"
                                id="save-print" href="#">
                                Print
                            </a>
                        </div>
