    ...
    <body>
        <tr>
            <th
                ...
                "
            >
                QP03 mẫu 2 (ngày ban hành: 6.2020, cải đính)
            </th>
        </tr>
        <br />
        <tr>
        ...
        >
            <thead>
                <tr>
                    ...
                    <th
                        style="vertical-align: middle; text-align: center; background-color: yellow; font-weight: bold; font-size: 14px; font-family: Arial, height: 100px; border: 1px solid black; padding: 10px;"
                        rowspan="3"
                    >
                        DỰ ĐỊNH VẬT LIỆU (KG)
                    </th>
