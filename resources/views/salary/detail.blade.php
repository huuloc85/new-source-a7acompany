            ...
            <div class="card">
                ...
                <div class="px-0 pb-2">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div
                            class="tab-pane fade show active category"
                            id="VVP"
                            role="tabpanel"
                            ...
                            <div class="px-0 pb-2">
                                ...
                                >
                                    <li class="nav-item" role="presentation">
                                        <button
                                            ...
                                            id="categoryVVP-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#categoryVVP"
                                            type="button"
                                            role="tab"
                                            aria-controls="categoryVVP"
                                            aria-selected="true"
                                        >
                                            Danh mục
                                        </button>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            ...
                                            id="salaryVVP-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#salaryVVP"
                                            type="button"
                                            role="tab"
                                            aria-controls="salaryVVP"
                                            aria-selected="false"
                                        >
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link tab-vvp"
                                            id="salary-detailVVP-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#salary-detailVVP"
                                            type="button"
                                            role="tab"
                                            aria-controls="salary-detailVVP"
                                            aria-selected="false"
                                        >
                                            Bảng lương chi tiết
                                        </button>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link tab-vvp"
                                            id="timekeepingVVP-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#timekeepingVVP"
                                            type="button"
                                            role="tab"
                                            aria-controls="timekeepingVVP"
                                            aria-selected="false"
                                        >
                                            Bảng chấm công
                                        </button>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    >
                                        <div class="px-0 pb-2">
                                            <div
                                                class="table-responsive p-0 d-flex flex-nowrap"
                                            >
                                                <div
                                                    class="col-4 category-left"
                                                >
                                                    <table
                                                    ...
                                                    >
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center col-3"
                                                                    rowspan="2"
                                                                >
                                                                    MS NV
                                                                </th>
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-4"
                                                                    rowspan="2"
                                                                >
                                                                    Họ và tên
                                                                </th>
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-3"
                                                                    rowspan="2"
                                                                >
                                                                    Bộ phận
                                                                </th>
                                                            ...
                                                            @foreach ($salaryOfficialsVVP as $key => $salaryOfficialVVP)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        >
                                                                            {{ $salaryOfficialVVP->employee->code }}
                                                                        </p>
                                                                    </td>
                                                                    <td>
                                                                        <p
                                                                        ...
                                                                        >
                                                                            {{ $salaryOfficialVVP->employee->name }}
                                                                        </p>
                                                                    </td>
                                                                    <td>
                                                                        <p
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <thead>
                                                            <tr>
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center col-1 bg-3"
                                                                >
                                                                    Lương ngày
                                                                    (áp dụng
                                                                    tháng đầu)
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center col-1 bg-2"
                                                                >
                                                                    Lương đêm
                                                                    (áp dụng
                                                                    tháng đầu)
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-1 bg-3"
                                                                >
                                                                    Lương CB thử
                                                                    việc / 26
                                                                    ngày
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-1 bg-2"
                                                                >
                                                                    Lương CB thử
                                                                    việc / 1 giờ
                                                                </th>
                                    ...
                                    >
                                        <div class="px-0 pb-2">
                                            <div
                                                class="table-responsive p-0 d-flex"
                                            >
                                                <table
                                                    ...
                                                    >
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-2"
                                                                >
                                                                    Họ và tên
                                                                </th>
                                                                <th
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->overtime_hours_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->overtime_hours_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->overtime_salary,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->overtime_day_count_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->allowance_overtime_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->holidays_count_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->holidays_money,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->paid_holidays_count_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->paid_holidays_money,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->business_travel_unit_price_hour,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->business_fuel_unit_price_day,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->advance_money,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        <div
                                                                            class="d-flex px-3 py-1"
                                                                        >
                                                                            {{ number_format($salaryOfficialVVP->unicon_deduction) }}
                                                                        </div>
                                                                    </td>
                                                                    <td
                                                                        class="bg-2"
                                                                    >
                                                                        <div
                                                                            class="d-flex px-3 py-1"
                                                                        >
                                                                            {{ $salaryOfficialVVP->unicon_deduction_notice }}
                                                                        </div>
                                                                    </td>
                                                                    <td
                                                                        class="bg-3"
                                                    ...
                                                    >
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-2 bg-3"
                                                                >
                                                                    Số giờ làm
                                                                    ngày
                                                                </th>
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-2 test-bg"
                                                                >
                                                                    Tính lương
                                                                    ngày
                                                                </th>
                                                                ...
                                                                <th
                                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center ps-2 col-2 bg-2"
                                                                >
                                                                    Phụ cấp tiền
                                                                    cơm ngày
                                                                </th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->total_day_offical,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->total_night_offical,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->total_overtime_offical,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->workday_count_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->worknight_count_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->overtime_day_count_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->allowance_rice_day_timekeeping,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->allowance_rice_night_timekeeping,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialVVP->allowance_overtime_timekeeping,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    @foreach ($salaryOfficialVVP->SalaryOfficialVVPTimekeepings as $key => $SalaryOfficialVVPTimekeeping)
                                                                        ...
                                                                        >
                                                                            {{
                                                                                date(
                                                                                    'd/m/Y',
                                                                                    strtotime($SalaryOfficialVVPTimekeeping->timekeeping_date)
                                                                                )
                                                                            }}
                                                                            <br />
                                                                            <div
                                                                                class="d-flex mg-top-9"
                                                                            >
                                                                                <div
                                                                                    class="col-4 bg-4 heigh-31 pd-top-8"
                                                                                >
                                                                                    Ngày
                                                                                </div>
                                                                                <div
                                                                                    class="col-4 bg-2 pd-top-8"
                                                                                >
                                                                                    Đêm
                                                                                </div>
                                                                                <div
                                                                                    class="col-4 bg-3 pd-top-8"
                                                                                >
                                                                                    TC
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($salaryOfficialsVVP as $key => $salaryOfficialVVP)
                                                                <tr>
                                                                    @foreach ($salaryOfficialVVP->SalaryOfficialVVPTimekeepings as $key => $SalaryOfficialVVPTimekeeping)
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                {{
                                                                                    number_format(
                                                                                        $SalaryOfficialVVPTimekeeping->timekeeping_day,
                                                                                        2
                                                                                    )
                                                                                }}
                                                                            </div>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                {{
                                                                                    number_format(
                                                                                        $SalaryOfficialVVPTimekeeping->timekeeping_night,
                                                                                        2
                                                                                    )
                                                                                }}
                                                                            </div>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                {{
                                                                                    number_format(
                                                                                        $SalaryOfficialVVPTimekeeping->timekeeping_overtime,
                                                                                        2
                                                                                    )
                                                                                }}
                                                                            </div>
                                                                    ...
                                                                    <td>
                                                                        <div
                                                                            class="d-flex px-3 py-1 text-center"
                                                                        >
                        ...
                        >
                            <div class="px-0 pb-2">
                                ...
                                >
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link tab-a7a active"
                                            id="categoryA7A-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#categoryA7A"
                                            type="button"
                                            role="tab"
                                            aria-controls="categoryA7A"
                                            aria-selected="true"
                                        >
                                            Danh mục
                                        </button>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link tab-a7a"
                                            id="salaryA7A-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#salaryA7A"
                                            type="button"
                                            role="tab"
                                            aria-controls="salaryA7A"
                                            aria-selected="false"
                                        >
                                            Bảng lương thanh toán
                                        </button>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link tab-a7a"
                                            id="salary-detailA7A-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#salary-detailA7A"
                                            type="button"
                                            role="tab"
                                            aria-controls="salary-detailA7A"
                                            aria-selected="false"
                                        >
                                            Bảng lương chi tiết
                                        </button>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link tab-a7a"
                                            id="timekeepingA7A-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#timekeepingA7A"
                                            type="button"
                                            role="tab"
                                            aria-controls="timekeepingA7A"
                                            aria-selected="false"
                                        >
                                            Bảng chấm công
                                        </button>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div
                                        class="tab-pane tab-a7a fade show active"
                                        id="categoryA7A"
                                        role="tabpanel"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p
                                                                            class="text-xs font-weight-bold mb-0 px-3"
                                                                        >
                                                                            {{ $salaryOfficialA7A->employee->code }}
                                                                        </p>
                                                                    </td>
                                                                    <td>
                                                                        <p
                                                                            class="text-xs font-weight-bold mb-0"
                                                                        >
                                                                            {{ $salaryOfficialA7A->employee->name }}
                                                                        </p>
                                                                    </td>
                                                                    <td>
                                                                        <p
                                    ...
                                    >
                                        <div class="px-0 pb-2">
                                            <div
                                                class="table-responsive p-0 d-flex salary-detail-css"
                                            >
                                                <table
                                                    class="table align-items-center mb-0 table-hover salary-detail-css"
                                                >
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->overtime_hours_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->overtime_hours_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->overtime_salary,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->overtime_day_count_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->allowance_overtime_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->holidays_count_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->holidays_money,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->paid_holidays_count_detail,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->paid_holidays_money,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->business_travel_unit_price_hour,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->business_fuel_unit_price_day,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->advance_money,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->total_day_offical,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->total_night_offical,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->total_overtime_offical,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->workday_count_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->worknight_count_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->overtime_day_count_trial,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->allowance_rice_day_timekeeping,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->allowance_rice_night_timekeeping,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            {{
                                                                                number_format(
                                                                                    $salaryOfficialA7A->allowance_overtime_timekeeping,
                                                                                    1
                                                                                )
                                                                            }}
                                                                        </div>
                                                                    ...
                                                                    @foreach ($salaryOfficialA7A->SalaryOfficialA7ATimekeepings as $key => $SalaryOfficialA7ATimekeeping)
                                                                        ...
                                                                        >
                                                                            {{
                                                                                date(
                                                                                    'd/m/Y',
                                                                                    strtotime($SalaryOfficialA7ATimekeeping->timekeeping_date)
                                                                                )
                                                                            }}
                                                                            <br />
                                                                            <div
                                                                    ...
                                                                    @foreach ($salaryOfficialA7A->SalaryOfficialA7ATimekeepings as $key => $SalaryOfficialA7ATimekeeping)
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                {{
                                                                                    number_format(
                                                                                        $SalaryOfficialA7ATimekeeping->timekeeping_day,
                                                                                        1
                                                                                    )
                                                                                }}
                                                                            </div>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                {{
                                                                                    number_format(
                                                                                        $SalaryOfficialA7ATimekeeping->timekeeping_night,
                                                                                        1
                                                                                    )
                                                                                }}
                                                                            </div>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                {{
                                                                                    number_format(
                                                                                        $SalaryOfficialA7ATimekeeping->timekeeping_overtime,
                                                                                        1
                                                                                    )
                                                                                }}
                                                                            </div>
