                                    ...
                                    <section>
                                        ...
                                        <div class="tab-content" id="{{ $leafTab['id'] }}Content">
                                            <div
                                                ...
                                                id="category{{ $keyRoot }}"
                                                role="tabpanel"
                                                aria-labelledby="category{{ $keyRoot }}-tab">
                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        <thead
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="bg-3">Lương CB thử việc / 26 ngày</th>
                                                                <th class="bg-2">Lương CB thử việc / 1 giờ</th>
                                                                <th class="bg-3">Lương CB thử việc tăng ca / 1 giờ</th>
                                                                <th class="bg-2">Phụ cấp học việc</th>
                                                                <th class="bg-3">Lương CB chính thức/ 26 ngày</th>
                                                                <th class="bg-2">Lương CB/ giờ</th>
                                                                <th class="bg-3">Lương TC/ giờ</th>
                                                                <th class="bg-2">Chuyên cần</th>
                                                                <th class="bg-3">Trách nhiệm</th>
                                                                <th class="bg-2">Phụ cấp tăng ca/ ngày</th>
                                                                <th class="bg-3">Phụ cấp đêm</th>
                                                                <th class="bg-2">Phụ cấp cơm trưa</th>
                                                                <th class="bg-3">BHXH công ty đóng</th>
                                                                <th class="bg-2">BHXH người lao động đóng</th>
                                                            </tr>
                                                        </thead>
                                            ...
                                            <div
                                                class="tab-pane fade"
                                                id="salary-detail{{ $keyRoot }}"
                                                role="tabpanel"
                                                aria-labelledby="salary-detail{{ $keyRoot }}-tab">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th>STT</th>
                                                                <th>MS NV</th>
                                                                <th class="ps-2">Họ và tên</th>
                                                                <th class="ps-2">Bộ phận</th>
                                                                <th class="bg-2">Số công ngày</th>
                                                                <th class="bg-2">Lương ca ngày (thử việc)</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số công đêm</th>
                                                                <th class="bg-3">Lương ca đêm (thử việc)</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Số giờ tăng ca ( thử việc)</th>
                                                                <th class="bg-3">Lương tăng ca (thử việc)</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số công</th>
                                                                <th class="bg-2">Phụ cấp học việc</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-3">Số giờ chính</th>
                                                                <th class="bg-3">Lương chính thức</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Chuyên cần</th>
                                                                <th class="bg-3">Số công làm</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số công làm</th>
                                                                <th class="bg-2">Trách nhiệm</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-3">Số giờ tăng ca</th>
                                                                <th class="bg-3">Lương tăng ca</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Số công ngày</th>
                                                                <th class="bg-2">Phụ cấp cơm ca ngày</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số công đêm</th>
                                                                <th class="bg-2">Phụ cấp ca đêm</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Số ngày tăng ca</th>
                                                                <th class="bg-3">Phụ cấp tăng ca</th>

                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-2">Số ngày lễ tết</th>
                                                                <th class="bg-2">Tiền lễ tết</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Phép năm</th>
                                                                <th class="bg-3">Tiền phép năm</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Số giờ đi công tác</th>
                                                                <th class="bg-3">Đơn giá đi công tác/ giờ</th>
                                                                <th class="bg-2">Lương đi công tác GCN</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số lần đi công tác</th>
                                                                <th class="bg-2">Đơn giá xăng công tác/ ngày</th>
                                                                <th class="bg-3">Phụ cấp xăng đi GCN</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Tiền giới thiệu người</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-2">Phụ cấp khác</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Tiền thưởng đạt chuyên cần</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-3">Ốm đau</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Ma chay</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-2">Tiền sinh nhật</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Tiền lương tháng trước bị thiếu</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-3">Tổng thu nhập</th>
                                                                <th class="bg-3">Khấu trừ BHXH 10.5%</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Tạm ứng</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số lần vi phạm</th>
                                                                <th class="bg-2">Phí công đoàn 1%</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-3">Số nghỉ có phép</th>

                                                                <th class="bg-3">Trừ tiền</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Số nghỉ không có phép</th>
                                                                <th class="bg-2">Trừ tiền</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Số lỗi nặng</th>
                                                                <th class="bg-2">Trừ tiền</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-3">Ghi chú Số lỗi nhẹ</th>
                                                                <th class="bg-3">Trừ tiền</th>
                                                                <th class="bg-3">Ghi chú</th>
                                                                <th class="bg-2">Trừ KPI</th>
                                                                <th class="bg-2">Ghi chú</th>
                                                                <th class="bg-2">Thực lãnh</th>
                                                                <th class="bg-2">Hình thức thanh toán</th>
                                                                <th class="bg-2">
                                                                    BHXH (21.5%)
                                                                    <br />
                                                                    công ty đóng cho NLĐ
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody class="text-center align-middle">
                                            ...
                                            <div
                                                class="tab-pane fade"
                                                id="timekeeping{{ $keyRoot }}"
                                                role="tabpanel"
                                                aria-labelledby="timekeeping{{ $keyRoot }}-tab">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        <thead class="table-light text-center align-middle">
                                                            <tr>
                                                                <th rowspan="2">STT</th>
                                                                <th rowspan="2">MS NV</th>
                                                                <th rowspan="2">Họ và tên</th>
                                                                <th rowspan="2">Bộ phận</th>
                                                                <th rowspan="2" class="bg-3">Số giờ làm ngày</th>
                                                                <th rowspan="2" class="bg-3">Số giờ làm đêm</th>
                                                                <th rowspan="2" class="bg-3">Số giờ tăng ca</th>
                                                                <th rowspan="2" class="test-bg">Tính lương ngày</th>
                                                                <th rowspan="2" class="test-bg">Tính lương đêm</th>
                                                                <th rowspan="2" class="test-bg">Tăng ca thử việc</th>
                                                                <th rowspan="2" class="bg-2">Phụ cấp tiền cơm ngày</th>
                                                                <th rowspan="2" class="bg-2">Phụ cấp ca đêm</th>
                                                                <th rowspan="2" class="bg-2">Phụ cấp tăng ca</th>
                                                                ...
                                                                <th rowspan="2">Có phép</th>
                                                                <th rowspan="2">Không phép</th>
                                                            </tr>
                                                            <tr>
                                                                @foreach ($leafTab['data'] as $key => $attendance)
                                                                    @foreach ($attendance['SalaryOfficial'.$keyRoot.'Timekeepings'] as $key => $attendanceTimekeeping)
                                                                        <th class="bg-4">Ngày</th>
                                                                        <th class="bg-2">Đêm</th>
                                                                        <th class="bg-3">TC</th>
                                                                    @endforeach
