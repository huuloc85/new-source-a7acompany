...
CREATE  PROCEDURE insert_eat_room_to_schedule_details(
    IN in_employee_id bigint, IN in_schedule_id bigint
)
BEGIN
  ...
  -- Day 1
  SELECT day1 INTO task_day1 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  VALUES (
  ...
  ON DUPLICATE KEY UPDATE
    is_eat_room = VALUES(is_eat_room),
    updated_at = VALUES(updated_at);

  -- Day 2
  SELECT day2 INTO task_day2 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 3
  SELECT day3 INTO task_day3 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 4
  SELECT day4 INTO task_day4 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 5
  SELECT day5 INTO task_day5 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 6
  SELECT day6 INTO task_day6 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 7
  SELECT day7 INTO task_day7 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 8
  SELECT day8 INTO task_day8 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 9
  SELECT day9 INTO task_day9 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 10
  SELECT day10 INTO task_day10 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 11
  SELECT day11 INTO task_day11 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 12
  SELECT day12 INTO task_day12 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 13
  SELECT day13 INTO task_day13 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 14
  SELECT day14 INTO task_day14 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 15
  SELECT day15 INTO task_day15 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 16
  SELECT day16 INTO task_day16 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 17
  SELECT day17 INTO task_day17 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 18
  SELECT day18 INTO task_day18 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 19
  SELECT day19 INTO task_day19 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 20
  SELECT day20 INTO task_day20 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 21
  SELECT day21 INTO task_day21 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 22
  SELECT day22 INTO task_day22 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 23
  SELECT day23 INTO task_day23 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 24
  SELECT day24 INTO task_day24 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 25
  SELECT day25 INTO task_day25 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 26
  SELECT day26 INTO task_day26 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 27
  SELECT day27 INTO task_day27 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 28
  SELECT day28 INTO task_day28 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 29
  SELECT day29 INTO task_day29 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 30
  SELECT day30 INTO task_day30 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
  ...
  -- Day 31
  SELECT day31 INTO task_day31 FROM celender_detail_eatroom WHERE employee_id = in_employee_id AND celender_id = in_schedule_id;
  INSERT INTO schedule_details (
    employee_id, schedule_id, date,
    is_eat_room, created_at, updated_at
  )
