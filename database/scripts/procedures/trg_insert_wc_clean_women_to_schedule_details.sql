drop procedure if exists trg_insert_wc_clean_women_to_schedule_details;
CREATE PROCEDURE trg_insert_wc_clean_women_to_schedule_details(IN p_employee_id BIGINT, IN p_celender_id BIGINT)
BEGIN
    ...
    ON DUPLICATE KEY
        UPDATE is_wc_clean_women = VALUES(is_wc_clean_women),
               updated_at = NOW();
END;
