    ...
    public function down(): void
    {
        Schema::table('salary_officials_a7a', function (Blueprint $table) {
            ...
            foreach ($columns as $column) {
                if (Schema::hasColumn('salary_officials_a7a', $column)) {
