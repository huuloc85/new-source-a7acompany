...
return new class extends Migration
{
    ...
    {
        Schema::create('timekeeping_officials_vvp', function (Blueprint $table) {
            $table->id();
            $table->foreignId('salary_official_vvp_id')->references('id')->on('salary_officials_vvp');
    ...
    {
        Schema::dropIfExists('timekeeping_officials_vvp');
    }
};
